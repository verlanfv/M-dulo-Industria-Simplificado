object frmRelEtiquetas: TfrmRelEtiquetas
  ...
  Caption = 'Relat'#243'rio  de Etiquetas  -  v.1.0'
  ClientHeight = 366
  ClientWidth = 520
  Color = clBtnFace
  ...
  object pnlFiltro: TPanel
    ...
    object edtDataIni: TDateTimePicker
      ...
      Width = 112
      Height = 21
      Date = 44028.388044444440000000
      Time = 44028.388044444440000000
      TabOrder = 0
      TabStop = False
    end
    ...
    object edtNrOrdemIni: TEdit
      ...
      TabOrder = 2
      Text = '0'
      OnExit = edtNrOrdemIniExit
    end
    object edtNrOrdemFim: TEdit
      Left = 297
      Top = 56
      Width = 112
      Height = 21
    ...
    object edtGrupoMais1: TEdit
      ...
      TabOrder = 6
      Text = '0'
      OnExit = edtGrupoMais1Exit
    end
    object edtGrupoMais2: TEdit
      Left = 176
      Top = 117
      Width = 40
      Height = 21
      TabOrder = 7
      Text = '0'
      OnExit = edtGrupoMais2Exit
    end
    object edtGrupoMais3: TEdit
      Left = 240
      Top = 117
      Width = 40
      Height = 21
      TabOrder = 8
      Text = '0'
      OnExit = edtGrupoMais3Exit
    end
    object edtGrupoMais4: TEdit
      Left = 304
      Top = 117
      Width = 40
      Height = 21
    ...
    object edtGrupoMais5: TEdit
      ...
      TabOrder = 10
      Text = '0'
      OnExit = edtGrupoMais5Exit
    end
    object edtGrupoMais6: TEdit
      Left = 112
      Top = 145
      Width = 40
      Height = 21
      TabOrder = 11
      Text = '0'
      OnExit = edtGrupoMais6Exit
    end
    object edtGrupoMais7: TEdit
      Left = 176
      Top = 144
      Width = 40
      Height = 21
      TabOrder = 12
      Text = '0'
      OnExit = edtGrupoMais7Exit
    end
    object edtGrupoMais8: TEdit
      Left = 240
      Top = 145
      Width = 40
      Height = 21
      TabOrder = 13
      Text = '0'
      OnExit = edtGrupoMais8Exit
    end
    object edtGrupoMais9: TEdit
      Left = 304
      Top = 145
      Width = 40
      Height = 21
      TabOrder = 14
      Text = '0'
      OnExit = edtGrupoMais9Exit
    end
    object edtGrupoMais10: TEdit
      Left = 369
      Top = 145
      Width = 40
      Height = 21
      TabOrder = 15
      Text = '0'
      OnExit = edtGrupoMais10Exit
    end
    object edtNrEtiquetas: TEdit
      Left = 97
      Top = 243
      Width = 55
      Height = 21
      TabOrder = 17
      Text = '1'
      OnExit = edtNrEtiquetasExit
    end
  end
  object pplRelOrdemProd: TppDBPipeline
    DataSource = dtsRelOrdemProd
    UserName = 'lRelOrdemProd'
    Left = 446
    Top = 208
    object pplRelOrdemProdppField1: TppField
      FieldAlias = 'coluna1'
      FieldName = 'coluna1'
      FieldLength = 255
      DisplayWidth = 255
    ...
    object pplRelOrdemProdppField2: TppField
      FieldAlias = 'coluna2'
      FieldName = 'coluna2'
      FieldLength = 255
      DisplayWidth = 255
    ...
    object pplRelOrdemProdppField3: TppField
      FieldAlias = 'coluna3'
      FieldName = 'coluna3'
      FieldLength = 255
      DisplayWidth = 255
    ...
    object pplRelOrdemProdppField4: TppField
      FieldAlias = 'coluna4'
      FieldName = 'coluna4'
      FieldLength = 255
      DisplayWidth = 255
  ...
  object pprRelatorioOrdemProducao: TppReport
    ...
    PrinterSetup.mmMarginTop = 15240
    ...
    Version = '16.02'
    mmColumnWidth = 48729
    DataPipelineName = 'pplRelOrdemProd'
  ...
  object dtsRelOrdemProd: TDataSource
    DataSet = cdsRelOrdemProd
    Left = 454
    Top = 272
  end
  object cdsRelOrdemProd: TClientDataSet
    PersistDataPacket.Data = {
      
    ...
    Left = 360
    Top = 272
    object cdsRelOrdemProdcoluna1: TStringField
      FieldName = 'coluna1'
      Size = 255
    end
    object cdsRelOrdemProdcoluna2: TStringField
      FieldName = 'coluna2'
      Size = 255
    end
    object cdsRelOrdemProdcoluna3: TStringField
      FieldName = 'coluna3'
      Size = 255
    end
    object cdsRelOrdemProdcoluna4: TStringField
      FieldName = 'coluna4'
      Size = 255
    end
  end
