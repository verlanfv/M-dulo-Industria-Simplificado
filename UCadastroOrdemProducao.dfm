object frmCadastroOrdemProducao: TfrmCadastroOrdemProducao
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Cadastro Ordem de Produ'#231#227'o - v.1.0'
  ClientHeight = 371
  ClientWidth = 675
  Color = clBtnFace
  ...
  object pnlOrdem: TPanel
    ...
    object edtQtdKG: TMaskEdit
      ...
      TabOrder = 3
      Text = '         ,   '
      OnClick = edtQtdKGClick
      OnEnter = edtQtdKGEnter
      OnExit = edtQtdKGExit
    end
    object edtDtValidade: TMaskEdit
      Left = 129
      Top = 5
      Width = 86
      Height = 21
      ...
      Text = '  /  /    '
      OnClick = edtDtValidadeClick
      OnEnter = edtDtValidadeEnter
      OnExit = edtDtValidadeExit
    end
    object edtQtdSC: TMaskEdit
      Left = 129
      Top = 35
      Width = 86
      Height = 21
      ...
      TabOrder = 1
      Text = '         ,  '
      OnClick = edtQtdSCClick
      OnEnter = edtQtdSCEnter
      OnExit = edtQtdSCExit
    end
    object edtVlrTotal: TMaskEdit
      Left = 129
      Top = 66
      Width = 86
      Height = 21
      ...
      TabOrder = 4
      Text = '         ,  '
      OnClick = edtVlrTotalClick
      OnEnter = edtVlrTotalEnter
      OnExit = edtVlrTotalExit
    end
    object cbxSituacao: TComboBox
      ...
      TabOrder = 5
      TabStop = False
      OnEnter = cbxSituacaoEnter
      OnExit = cbxSituacaoExit
      Items.Strings = (
        ' ABERTO'
        ' FINALIZADO')
    end
    object edtQtdPC: TMaskEdit
      Left = 306
      Top = 35
      Width = 86
      Height = 21
      ...
      TabOrder = 2
      Text = '         ,  '
      OnClick = edtQtdPCClick
      OnEnter = edtQtdPCEnter
      OnExit = edtQtdPCExit
    end
  end
